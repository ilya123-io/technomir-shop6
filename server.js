...
pool.query(`
    ...
    CREATE TABLE IF NOT EXISTS orders (id SERIAL PRIMARY KEY, name TEXT, phone TEXT, items TEXT);
`);
...
app.post('/order', async (req, res) => {
    ...
    try {
        await pool.query('INSERT INTO orders (name, phone, items) VALUES ($1, $2, $3)', [name, phone, items]);
